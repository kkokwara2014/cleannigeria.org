...
class CreateSurvmodelvisualizationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('survmodelvisualizations', function (Blueprint $table) {
            $table->engine='InnoDB';
    ...
    {
        Schema::dropIfExists('survmodelvisualizations');
    }
}
