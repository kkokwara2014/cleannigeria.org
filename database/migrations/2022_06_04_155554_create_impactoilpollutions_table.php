...
class CreateImpactoilpollutionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('impactoilpollutions', function (Blueprint $table) {
            $table->engine='InnoDB';
    ...
    {
        Schema::dropIfExists('impactoilpollutions');
    }
}
