        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box">
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form action="{{ route('documentregisters.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('doctitle') ? ' is-invalid' : '' }}"
                                            name="doctitle" value="{{ old('doctitle') }}" placeholder="Document Title" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('docnumber') ? ' is-invalid' : '' }}"
                                            name="docnumber" value="{{ old('docnumber') }}" placeholder="Document Number" required maxlength="21">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('revisionstatus') ? ' is-invalid' : '' }}"
                                            name="revisionstatus" value="{{ old('revisionstatus') }}" placeholder="Revision Status" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control{{ $errors->has('dateprepared') ? ' is-invalid' : '' }}"
                                            name="dateprepared" value="{{ old('dateprepared') }}" placeholder="Date Prepared" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" cols="30" rows="1" placeholder="Document description"></textarea>
                                        
                                    </div>
                                    <div class="form-group">
                                        <label>Upload File <span style="color: red">* (PDF only)</span></label>
                                        <input type="file" name="docfilename" required>
                                    </div>
                                </div>
