            ...
            <div class="col-md-12">
                ...
                <p>
                   @if ($incidmgt->isapproved==1)
                        <a
                            href="{{ route('makefinalassessment',[$incidmgt->competenceassessment_id,$incidmgt->user->id]) }}"><span
                                class="fa fa-eye text-primary"></span> View Final Approval
                        </a>
                   @endif
                </p>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <button class="btn btn-success btn-block btn-sm">
                            ...
                            This Individual Competence Assessment has been completely assessed and reviewed by the
                            Assessor.
                        </button>
                    ...
                    <div class="col-md-2">
                        ...
                        <button class="btn btn-success btn-block btn-sm"><span class="fa fa-thumbs-o-up"></span>
                            Approved
                        </button>
                        @else
                        <button class="btn btn-danger btn-block btn-sm"><span class="fa fa-thumbs-o-down"></span>
                            Not Yet Approved
                        </button>
                        @endif
                        @endif
                    ...
                    <div class="col-md-2">
                        ...
                        <a target="_blank"
                            ...
                            class="btn btn-primary btn-sm btn-block btnprnt"><span class="fa fa-print"></span>
                            Print Report</a>
