                        ...
                        <form action="{{ route('transfer.update',$transfer->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="srequipment_id" class="form-control" autofocus>
                                    ...
                                    <option value="{{$srequipment->id}}" {{ $srequipment->id== $transfer->srequipment_id?'selected':'' }}>{{'#'.$srequipment->refnumb.' - '.$srequipment->name.' in '.$srequipment->store->location->name.' Qty = '.$srequipment->qty}}
                                    </option>
                                    @endforeach
                            ...
                            <div class="form-group has-feedback{{ $errors->has('to_location_id')?'has-error':'' }}">
                                ...
                                <select name="to_location_id" class="form-control" autofocus>
                                    ...
                                    <option value="{{$location->id}}" {{ $location->id==$transfer->to_location_id?'selected':'' }}>{{$location->name}}
                                    </option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control{{ $errors->has('qty') ? ' is-invalid' : '' }}"
                                    name="qty" value="{{ $transfer->qty }}" placeholder="Quantity" autofocus
