                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('lastname') ? ' is-invalid' : '' }}"
                                            name="lastname" value="{{ $trainee->lastname }}" placeholder="Last Name" autofocus required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('firstname') ? ' is-invalid' : '' }}"
                                            name="firstname" value="{{ $trainee->firstname }}" placeholder="first Name" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('othername') ? ' is-invalid' : '' }}"
                                            name="othername" value="{{ $trainee->othername }}" placeholder="Other Name" autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control{{ $errors->has('traineeemail') ? ' is-invalid' : '' }}"
                                            name="traineeemail" value="{{ $trainee->traineeemail }}" placeholder="Email Address" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control{{ $errors->has('phone') ? ' is-invalid' : '' }}"
                                            name="phone" value="{{ $trainee->phone }}" placeholder="Phone Number" required pattern="[0-9]+" maxlength="11">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control{{ $errors->has('companyname') ? ' is-invalid' : '' }}"
                                            name="companyname" value="{{ $trainee->companyname }}" placeholder="Company Name" required>
