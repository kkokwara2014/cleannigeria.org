            ...
            <div class="col-md-11">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ route('cnapartners.update',$partner->id) }}" method="post">
                            @csrf
                           @method('put')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="lastname" type="text"
                                            ...
                                            name="lastname" value="{{ $partner->lastname }}" autofocus
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="firstname" type="text"
                                            ...
                                            name="firstname" value="{{ $partner->firstname }}" autofocus
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email"
                                            ...
                                            name="email" value="{{ $partner->email }}" autofocus placeholder="Email"
                                            required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="phone" type="tel"
                                            ...
                                            name="phone" value="{{ $partner->phone }}" placeholder="Phone" maxlength="11"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="location_id" class="form-control">
                                        <option selected="disabled" value="" required>Select Partner Location</option>
                                        @foreach ($locations as $location)
                                        <option value="{{$location->id}}" {{ $partner->location_id==$location->id?'selected':'' }}>{{$location->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select name="company_id" class="form-control">
                                        <option selected="disabled" value="" required>Select Partner Company</option>
                                        @foreach ($companies as $company)
                                        <option value="{{$company->id}}" {{ $partner->company_id==$company->id?'selected':'' }}>{{$company->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
