                        ...
                        <table id="example1" class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('leave.show',$leave->id) }}"><span
                                                class="fa fa-eye fa-2x text-primary"></span></a></td>
                                    <td>
                                        
                                            @foreach ($leaveapprovers as $approver)
                                               @foreach ($leave->approvedleaves as $apl)
                                                    @if ($approver->id==$apl->user_id)
                                    ...
                                    <td>
                                        <div class="dropdown"> <button type="button"
                                            ...
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                ...
                                                {{-- @if (($user->id==$leave->sendto_id ||Auth::user()->hasAnyRole(['Admin']) && $leave->isapproved==0)) --}}
                                                @if ((Auth::user()->hasAnyRole(['Admin']) && $leave->isapproved==0))
