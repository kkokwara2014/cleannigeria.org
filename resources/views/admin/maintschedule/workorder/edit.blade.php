...
@section('title')
Edit {{ $workorder->maintoption }} Work Order
@endsection
                        ...
                        <form action="{{ route('workorder.update',$workorder->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="uniquecode"
                                    value="{{ $workorder->uniquecode }}" readonly style="font-size: 25px;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="srequipment_id" class="form-control" required>
                                    ...
                                    <option value="{{ $srequipment->id }}" {{ $workorder->srequipment_id==$srequipment->id ?
                            ...
                            <div class="form-group">
                                ...
                                <select name="vendor_id" class="form-control" required>
                                    ...
                                    <option value="{{ $vendor->id }}" {{ $workorder->vendor_id==$vendor->id ?
                                        'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="amount" placeholder="Amount e.g 15000" pattern="[0-9]+" maxlength="11" value="{{ $workorder->amount }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Maintenance Due Date <span style="color: red">*</span></label>
                                        <input type="date" class="form-control" name="duedateformaint" value="{{ $workorder->duedateformaint }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" cols="30" name="description" class="form-control"
                                    placeholder="Your description here...">{{ $workorder->description }}</textarea>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="sentto_id" class="form-control" required>
                                    ...
                                    <option value="{{ $sentto->id }}" {{ $workorder->sentto_id==$sentto->id ?
                                        'selected' : '' }}>
                            ...
                            <input type="hidden" name="maintoption" value="{{ $workorder->maintoption }} ">
