...
<div class="row">
    ...
    <section class="col-lg-12 connectedSortable">
        <a href="{{ route('service.index') }}" class="btn btn-success btn-sm">
            <span class="fa fa-eye"></span> All Services
        </a>
        <br><br>
                        ...
                        <form action="{{ route('service.update',$service->id) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    name="title" value="{{ $service->title }}" placeholder="service Title"
                                    autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="" cols="30" rows="2"
                                    ...
                                    placeholder="Description">{{ $service->description }}
                                                        </textarea>
                            ...
                            <a href="{{ route('service.index') }}" class="btn btn-default btn-sm">Cancel</a>
