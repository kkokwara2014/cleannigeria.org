...
@section('title')
 Submitted Competence Assessments
@endsection
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-responsive table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($submittedcomptassessments as $subcomptass)
                                @if ($subcomptass->user_id==Auth::user()->id || $subcomptass->sentto_id==Auth::user()->id || ($subcomptass->senttosuperior_id==Auth::user()->id) ||  Auth::user()->hasAnyRole(['Admin']) || Auth::user()->hasAnyRole(['General Manager']))
                                <tr>
