...
@section('title')
 Competence Assessment(s) for You
@endsection
            ...
            @include('admin.messages.success')
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                       ...
                       @if ($submittedcomptassforyou->count())
                       <table id="example1" class="table table-responsive table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach ($submittedcomptassforyou as $subcomptass)
                       ...
                       @else
                           <h4 style="color: red">There is no Competence Assessment for You!</h4>
                       @endif
