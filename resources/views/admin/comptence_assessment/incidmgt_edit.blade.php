            ...
            <div class="col-md-8">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{ route('incidentmgt.update',[$incidmgt->id,$ctass->slug]) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <select name="legend_id" class="form-control" required>
                                    ...
                                    <option value="{{ $level->id }}"
                                        {{ $level->id==$incidmgt->legend_id?'selected':'' }}>{{ $level->name }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="evidence" class="form-control" cols="30" rows="3" required
                                    placeholder="Enter evidence">{{ $incidmgt->evidence }}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="sentto_id" class="form-control" required>
                                    ...
                                    <option value="{{ $sentto->id }}">{{ $sentto->firstname.' '.$sentto->lastname }}</option>
                                    @endforeach
                                </select>
                            </div>
