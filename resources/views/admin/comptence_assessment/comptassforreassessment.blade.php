...
@section('title')
 Competence Assessment(s) for Reassessment
@endsection
            ...
            @include('admin.messages.success')
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                       ...
                       @if ($submittedcomptassforsuperior->count())
                       <table id="example1" class="table table-responsive table-bordered table-striped">
                        ...
                        <tbody>
                            @foreach ($submittedcomptassforsuperior as $subcomptass)
                       ...
                       @else
                           <h4 style="color: red">There is no Competence Assessment for reassessment! Please, check later.</h4>
                       @endif
